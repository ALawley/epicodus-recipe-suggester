...
// var teriakiBeef = new Recipe("http://hostedmedia.reimanpub.com/TOH/Images/Photos/37/300x300/exps33521_SD955952D19.jpg", "Taste of Home", "tasteofhome.com",  "http://www.tasteofhome.com/recipes/teriyaki-zucchini-and-onion", "Teriaki Beef", ingredients[zucchini, onion, butter, teriaki, sesame seeds (optional)])
// newBottomShelf.recipeArray.push(teriakiBeef)

// var stroganoff = new Recipe("http://foodnetwork.sndimg.com/content/dam/images/food/fullset/2012/11/12/0/FN_Paula-Deen-Beef-Stroganoff_s4x3.jpg.rend.sni12col.landscape.jpeg", "food network", "foodnetwork.com", "http://www.foodnetwork.com/recipes/paula-deen/beef-stroganoff-recipe.html", "Beef Stroganoff", ingredients[beef, flour, olive oil, butter, onion, mushrooms, beef broth, cream of mushroom, pepper, sour cream, egg noodle])
// newBottomShelf.recipeArray.push(stroganoff)

// var risotto = new Recipe("http://cdn-image.myrecipes.com/sites/default/files/styles/300x300/public/image/recipes/sl/12/03/chicken-risotto-spring-vegetables-sl-x.jpg?itok=2yrT1ExR", "My Recipes", "myrecipes.com", "http://www.myrecipes.com/recipe/chicken-risotto-spring-vegetables", "Chicken Risotto with Spring Vegetables", ingredients[chicken broth, asparagus spears, chicken breasts, butter, olive oil, zucchini, onion, arborio rice, white wine, parmesan cheese, fontina cheese, parsley] )
// newBottomShelf.recipeArray.push(risotto)

// var teriyakiChicken = new Recipe("http://images.edge-generalmills.com/de3c686e-05e1-4cf6-9b36-cd604b9703a2.jpg", "Betty Crocker", "bettycrocker.com", "http://www.bettycrocker.com/recipes/teriyaki-chicken-stir-fry/87b85076-efa5-4acf-90e0-f84fd5bd3353", "Teriaki Chicken", ingredients[chicken breast, teriaki sauce, lemon juice, bag of frozen broccoli, carrots, waterchestnuts and redpeppers, a starch (ie. rice, couscous, noodles])
// newBottomShelf.recipeArray.push(teriyakiChicken)

// var ratatouille = new Recipe("http://www.cdkitchen.com/recipes/images/2013/08/55326-3119-mx.jpg", "cd Kitchen", "cdkitchen.com", "http://www.cdkitchen.com/recipes/recs/1551/Mushroom-Ratatouille84542.shtmlf", "Ratatouille", ingredients[mushrooms, onion, eggplant, zucchini, red bell pepper, tomato, olive oil, garlic])
